                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter firstname"
                                            id="firstname" name="firstname" pattern="[A-Za-z\s]+"
                                            title="Only alphabets and white space allowed." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="lastname" class="col-sm-3 control-label">Last Name</label>
                                        <input type="text" class="form-control" placeholder="Enter lastname"
                                            id="lastname" name="lastname" pattern="[A-Za-z\s]+"
                                            title="Only alphabets and white space allowed." required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="contact" name="contact"
                                            pattern="[0-9]{11}" title="11-digit number only and starts with 09."
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Enter 10-digits SSS number" id="sss" name="sss"
                                                pattern="[0-9]{10}" title="SSS number consists of 10 digits">
                                        </div>
                                        <div class="form-group">
                                            <label for="pagibig" class="col-sm-3 control-label">Pag-ibig</label>
                                            <input type="text" class="form-control"
                                                placeholder="Enter 12-digits Pag-ibig number" id="pagibig"
                                                name="pagibig" pattern="[0-9]{12}"
                                                title="Pag-ibig number consists of 12 digits">
                                        </div>
                                        <div class="form-group">
                                            <label for="philhealth" class="col-sm-3 control-label">Philhealth</label>
                                            <input type="text" class="form-control"
                                                placeholder="Enter 12-digits Philhealth number" id="philhealth"
                                                name="philhealth" pattern="[0-9]{12}"
                                                title="Philhealth number consists of 12 digits">
                                        </div>
                                        <div class="form-group">
                                            <label for="tin" class="col-sm-3 control-label">Tin</label>
                                            <input type="text" class="form-control"
                                                placeholder="Enter 9-digits Tin number" id="tin" name="tin"
                                                pattern="[0-9]{9}" title="Tin number consists of 9 digits">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
        ...
        <div class="modal-content">
            <form method="POST" action="employee_edit.php">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter firstname"
                                            id="edit_firstname" name="firstname" pattern="[A-Za-z\s]+"
                                            title="Only alphabets and white space allowed." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="edit_lastname" class="col-sm-3 control-label">Last Name</label>
                                        <input type="text" class="form-control" placeholder="Enter lastname"
                                            id="edit_lastname" name="lastname" pattern="[A-Za-z\s]+"
                                            title="Only alphabets and white space allowed." required>
                                    </div>
                                    <div class="form-group">
                                        <label for="edit_address" class="col-sm-3 control-label">Address</label>
                                        <textarea class="form-control" name="address" id="edit_address"
                                            placeholder="Enter Address"></textarea>
                                    </div>
                                    <div class="form-group">
                                ...
                                <form role="form">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Enter 10-digits SSS number" id="edit_sss" name="sss"
                                                pattern="[0-9]{10}" title="SSS number consists of 10 digits">
                                        </div>
                                        <div class="form-group">
                                            <label for="edit_pagibig" class="col-sm-3 control-label">Pag-ibig</label>
                                            <input type="text" class="form-control"
                                                placeholder="Enter 12-digits Pag-ibig number" id="edit_pagibig"
                                                name="pagibig" pattern="[0-9]{12}"
                                                title="Pag-ibig number consists of 12 digits">
                                        </div>
                                        <div class="form-group">
                                            <label for="edit_philhealth"
                                                class="col-sm-3 control-label">Philhealth</label>
                                            <input type="text" class="form-control"
                                                placeholder="Enter 12-digits Philhealth number" id="edit_philhealth"
                                                name="philhealth" pattern="[0-9]{12}"
                                                title="Philhealth number consists of 12 digits">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Enter 9-digits Tin number" id="edit_tin" name="tin"
                                                pattern="[0-9]{9}" title="Tin number consists of 9 digits">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i
                            class="fa fa-close"></i> Close</button>
                    <button type="submit" class="btn btn-primary btn-flat" name="edit"><i
