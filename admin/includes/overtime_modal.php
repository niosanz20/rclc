        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success btn-flat" name="edit"><i
                        class="glyphicon glyphicon-ok-circle"></i> Yes</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="overtime_delete.php">
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="othour"></h4>
                        <div class="form-group">
                            <input type="checkbox" name="reason[]" value="Late Logout">Late Logout
                            <input type="checkbox" name="reason[]" value="Non Authorize">Non Authorize
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger btn-flat" name="delete"><i
                        class="glyphicon glyphicon-ban-circle"></i> Yes</button>
                </form>
            </div>
        </div>
    </div>
