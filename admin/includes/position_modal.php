          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="position_add.php">
          		  <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="title" name="title" pattern="[A-Za-z\s]+" title="Only alphabets and white space allowed." required>
                  	</div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="rate" name="rate" pattern="[0-9.]+" required>
                    </div>
                </div>
          	</div>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_title" name="title" pattern="[A-Za-z\s]+" title="Only alphabets and white space allowed." required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_rate" name="rate" pattern="[0-9.]+" required>
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
