            ...
            <div class="box-header with-border">
              <div class="pull-right">
                <form method="POST" class="form-inline" id="payForm" action="payroll_generate.php" target="_blank">
                  ...
                  <!--<input type="button" class="btn btn-success btn-sm btn-flat" id="payroll" onclick = "window.open('payroll_generate.php')" target = "_blank"><span class="glyphicon glyphicon-print"></span> Payroll-->
                  <button type="submit" class="btn btn-success btn-sm btn-flat" id="payroll"><span class="glyphicon glyphicon-print"></span> Payroll</button>
                    ...
                    //   echo $pmlogs;
                      ...
                      echo "
                        ...
                        <!--  <td>".$row['employee_id']."</td> -->
                          ...
                          <td>".number_format($pmlogs_price, 2)."</td>
...
// //     // var tab = $('#payForm').attr('payroll_generate.php', '_blank');
// //     // var tab = $('#payForm').attr(window.open('payroll_generate.php','_blank'));
//         // $('#payForm').submit();
//         // var tab = $('#payForm').attr('action', window.open('payroll_generate.php', '_blank'));
//         // tab.focus();
    
// //     // var url = $('#payForm').attr('action','payroll_generate.php');
