                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3" id="filter-date-section" style="display: none">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><span class="glyphicon glyphicon-file"></span>Payroll Summary for
                            <strong id="employee_name"></strong></h4>
                    </div>
