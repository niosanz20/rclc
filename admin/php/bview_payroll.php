              ...
              -->
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="viewPayrollDetails btn btn-success btn-sm btn-flat" id="<?php echo $empID ?>"><span class="glyphicon glyphicon-file"></span> Print</button>
                                </td>
                            </tr>
            ...
            <table class="greyGridTable">
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="10%" align="left">: <?php echo $rowpaylsipcutoff['firstname'] . ' ' . $rowpaylsipcutoff['lastname'] ?></td>
                        <td width="10%"></td>
                        <td width="20%" align="left"><b>TAX STATUS</b></td>
                        <td width="10%" align="left">: <?php echo $rowpaylsipcutoff['tax_status'] ?></td>
                    </tr>
                    <tr>
                        <td width="20%" align="left"><b>PAYROLL DATE</b></td>
                        <td width="10%" align="left">: <?php echo $pay_date = date("M j Y", strtotime($rowpaylsipcutoff['payroll_date'])); ?></td>
                        <td width="10%"></td>
                    ...
                    <tr>
                        ...
                        <td width="20%" align="left">: (<?php echo $start_date = date("M j, Y", strtotime($rowpaylsipcutoff['start_date'])) . ' - ' . $end_date = date("M j, Y", strtotime($rowpaylsipcutoff['end_date'])); ?>)</td>
                        <td width="10%"></td>
                    ...
                    <tr>
                        ...
                        <td width="10%" align="left">: <?php echo $rowpaylsipcutoff['description'] ?></td>
                        <td width="10%"></td>
            ...
            <table class="greyGridTable" id="secondTable">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th>₱ <?php echo $rowpaylsipcutoff['total_compensation']; ?></th>
                        <th>TOTAL <br> DEDUCTIONS
                        </th>
                        <th>₱ <?php echo $rowpaylsipcutoff['total_deduc']; ?></th>
                        <th>NET PAY</th>
                        <th>₱ <?php echo $rowpaylsipcutoff['netpay']; ?></th>
                    </tr>
                </tfoot>
                <tbody>
                    <tr>
                        <td width="20%" align="left"><b>RATE per HOUR</b></td>
                        <td width="10%" align="left"><?php echo $rowpaylsipcutoff['rate'] ?></td>
                        <td width="20%" align="left"><b>CASH ADVANCE</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['cash_advance']; ?></td>
                        <td width="20%" align="left"><b>TAX</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['tax']; ?></td>
                    </tr>
                    <tr>
                        <td width="20%" align="left"><b>TOTAL HOURS</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['total_hour']; ?></td>
                        <td width="20%" align="left"><b>SSS</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['sss']; ?></td>
                        <td width="20%" align="left"><b>SSS</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['ytd_sss']; ?></td>
                    </tr>
                    <tr>
                        <td width="20%" align="left"><b>BASIC</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['basic_pay']; ?></td>
                        <td width="20%" align="left"><b>PHILHEALTH</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['philhealth']; ?></td>
                        <td width="20%" align="left"><b>PHILHEALTH</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['ytd_philhealth']; ?></td>
                    </tr>
                    <tr>
                        <td width="20%" align="left"><b>OT (10 hrs)</b></td>
                        <!--insert code for total hours ng OT -->
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['ot']; ?></td>
                        <td width="20%" align="left"><b>HDMIF</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['hdmif']; ?></td>
                        <td width="20%" align="left"><b>HDMIF</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['ytd_hdmif']; ?></td>
                    </tr>
                    <tr>
                        <td width="20%" align="left"><b></b></td>
                        <td width="10%" align="right"></td>
                        <td width="20%" align="left"><b>MATERIAL LOST</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['material_cost']; ?></td>
                        <td width="20%" align="left"><b>GROSS INCOME</b></td>
                        <td width="10%" align="right"><?php echo $rowpaylsipcutoff['ytd_grossincome']; ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
