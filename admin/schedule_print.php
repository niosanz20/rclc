...
function generateRow($conn)
{
    ...
    $sql = "SELECT *, employees.id AS empid FROM employees LEFT JOIN schedules ON schedules.id=employees.schedule_id ORDER BY lastname";
...
$pdf->SetTitle('RC Llaguno Construction - Employee Schedule');
